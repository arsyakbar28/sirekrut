...
<nav class="topbar topbar-inverse topbar-expand-md">
    <div class="container">
        ...
        <div class="topbar-left">
            <a class="topbar-brand d-flex justify-content-center" href="{{ url('/') }}">
                <img src="{{ $global->logo_url }}" width="300" class="logo-inverse" alt="home" />
            </a>
        </div>
    </div>
</nav>
    ...
    <div class="container">
        <div class="row gap-y align-items-center">
            <div class="col-3 col-lg-3 text-center mr-auto">
                &copy; {{ \Carbon\Carbon::today()->year }} Schiene Tren
