            ...
            <div class="card">
                <div class="card-body">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <a href="{{ route('admin.interview-schedule.index') }}" class="btn btn-outline btn-primary btn-sm">
                                    <i class="fa fa-calendar"></i> Tampilan Kalender
                                </a>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <form class="form-inline justify-content-lg-end " style="align-items: end !important; ">
                                ...
                                <button type="button" id="changeMultipleStatus" class="btn btn-success"><i class="fa fa-check"></i> Terapkan</button>
                            </form>
                    ...
                    <div class="row b-b b-t mb-3" style="display: none; background: #fbfbfb;" id="ticket-filters">
                        <div class="col-md-12">
                            <h4 class="mt-2">Filter Menurut <a href="javascript:;" class="pull-right toggle-filter"><i class="fa fa-times-circle-o"></i></a></h4>
                        </div>
                         <div class="col-md-12">
                                 ...
                                 <div class="col-md-4">
                                     <div class="example">
                                         <div class="input-daterange input-group" id="date-range">
                                             ...
                                             <span class="input-group-addon bg-info b-0 text-white p-1">Terapkan Untuk</span>
