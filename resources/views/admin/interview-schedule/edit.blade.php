                ...
                <div class="col-md-6 col-xs-12">
                    <div class="form-group">
                        ...
                        <select class="select2 m-b-10 form-control select2-multiple " multiple="multiple"
                                data-placeholder="Pilih Karyawan" name="employee[]" id="employee">
...
<div class="modal-footer">
    ...
    <button type="button" class="btn btn-success update-schedule">Ubah</button>
</div>
