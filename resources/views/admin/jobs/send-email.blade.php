...
@section('create-button')
    <a href="{{ route('admin.job-applications.create') }}" class="btn btn-dark btn-sm m-l-15"><i class="fa fa-plus-circle"></i>Buat Baru</a>
@endsection
@endpermission
    ...
    <script>
        ...
        $('#send-emails').click(function (e) {
            ...
            if (allSelected || selected.length > 0) {
                ...
                $.showToastr('Silahkan pilih pelamar sebelum mengirim email', 'error');
            }
        })
