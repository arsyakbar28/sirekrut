                ...
                <div class="card-body">
                    ...
                    <form id="editSettings" class="ajax-form">
                        ...
                        <div class="form-group">
                            ...
                            <span class="help-block"> Catatan Password</span>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-11">
                                    <div class="form-row">
                                        <div class="col-md-4 mb-2">
                                            <select name="calling_code" id="calling_code" class="form-control selectpicker" data-live-search="true" data-width="100%">
                                                <?php $__currentLoopData = $calling_codes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <?php if($team->calling_code): ?>
                                                        <?php echo e($team->calling_code == $value['dial_code'] ? 'selected' : ''); ?>
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" class="form-control" name="mobile" value="<?php echo e($team->mobile); ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-1 text-center">
                                    <?php if($team->mobile_verified): ?>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <input type="file" id="input-file-now" name="image" accept=".png,.jpg,.jpeg" class="dropify"
                                           data-default-file="<?php echo e($team->profile_image_url); ?>"
                                    />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="role_id" id="role_id">
                                <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option
                                            <?php if($role->id == $team->role->role_id): ?> selected <?php endif; ?>
...
<?php $__env->startPush('footer-script'); ?>
    ...
    <script>
        ...
        $('#save-form').click(function () {
            $.easyAjax({
                url: '<?php echo e(route('admin.team.update', $team->id)); ?>',
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\kuliah\Belajar\web\laravel\SiRekrutV1\resources\views/admin/team/edit.blade.php ENDPATH**/ ?>