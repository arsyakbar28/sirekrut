            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <a href="<?php echo e(route('admin.interview-schedule.index')); ?>" class="btn btn-outline btn-primary btn-sm">
                                    <i class="fa fa-calendar"></i> <?php echo app('translator')->get('modules.interviewSchedule.calendarView'); ?>
                                </a>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <form class="form-inline justify-content-lg-end " style="align-items: end !important; ">
                                <div class="form-group mr-3" style="width:50%">
                                    <select name="statusMultiple" id="statusMultiple" class="select2 form-control" style="width:100%;">
                                        <option value="selectStatus"><?php echo app('translator')->get('modules.interviewSchedule.selectStatus'); ?></option>
                                        <option value="rejected"><?php echo app('translator')->get('app.rejected'); ?></option>
                                        <option value="hired"><?php echo app('translator')->get('app.hired'); ?></option>
                                ...
                                <button type="button" id="changeMultipleStatus" class="btn btn-success"><i class="fa fa-check"></i> <?php echo app('translator')->get('app.apply'); ?></button>
                            </form>
                    ...
                    <div class="row b-b b-t mb-3" style="display: none; background: #fbfbfb;" id="ticket-filters">
                        <div class="col-md-12">
                            <h4 class="mt-2"><?php echo app('translator')->get('app.filterBy'); ?> <a href="javascript:;" class="pull-right toggle-filter"><i class="fa fa-times-circle-o"></i></a></h4>
                        </div>
                         <div class="col-md-12">
                             ...
                             <form action="" class="row" id="filter-form" style="width: 100%;">
                                 ...
                                 <div class="col-md-4">
                                     <div class="form-group">
                                         <select class="form-control select2" name="applicationID" id="applicationID" data-style="form-control">
                                             <option value="all"><?php echo app('translator')->get('modules.interviewSchedule.allCandidates'); ?></option>
                                             <?php $__empty_1 = true; $__currentLoopData = $candidates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $candidate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                 <option value="<?php echo e($candidate->id); ?>"><?php echo e(ucfirst($candidate->full_name)); ?></option>
                                 ...
                                 <div class="col-md-4">
                                     <div class="form-group">
                                         <select class="form-control select2" name="status" id="status" data-style="form-control">
                                             <option value="all"><?php echo app('translator')->get('modules.interviewSchedule.allStatus'); ?></option>
                                             <option value="pending"><?php echo app('translator')->get('app.pending'); ?></option>
                                             <option value="rejected"><?php echo app('translator')->get('app.rejected'); ?></option>
                                             <option value="hired"><?php echo app('translator')->get('app.hired'); ?></option>
                                             <option value="canceled"><?php echo app('translator')->get('app.canceled'); ?></option>
                                 ...
                                 <div class="col-md-3">
                                    <div class="form-group">
                                        <button type="button" id="apply-filters" class="btn btn-sm btn-success"><i class="fa fa-check"></i> <?php echo app('translator')->get('app.apply'); ?></button>
                                        <button type="button" id="reset-filters" class="btn btn-sm btn-dark "><i class="fa fa-refresh"></i> <?php echo app('translator')->get('app.reset'); ?></button>
                                    </div>
                                 </div>
                             </form>
                         </div>
                    ...
                    <div class="table-responsive m-t-40">
                        <table id="myTable" class="table table-bordered table-striped">
                            ...
                            <tr>
                                ...
                                <th><?php echo app('translator')->get('app.candidate'); ?></th>
                                <th><?php echo app('translator')->get('menu.interviewDate'); ?></th>
...
<?php $__env->startPush('footer-script'); ?>
    ...
    <script>
        ...
        var table = $('#myTable').dataTable({
            ...
            destroy: true,
            ajax: {
                'url': '<?php echo route('admin.interview-schedule.data'); ?>',
                'data': function(d) {
                    return $.extend({}, d, {
        ...
        function changeMultipleStatus(status, mailToCandidate){
            ...
            var url = "<?php echo e(route('admin.interview-schedule.change-status-multiple')); ?>";
            $.easyAjax({
                url: url,
                type: "POST",
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SiRekrutV1\resources\views/admin/interview-schedule/table.blade.php ENDPATH**/ ?>