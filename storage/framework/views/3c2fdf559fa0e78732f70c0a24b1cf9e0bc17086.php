            ...
            <div class="row">
                <div class="col-md-6  col-xs-12">
                    <div class="form-group">
                        ...
                        <input type="hidden" name="candidates[]" value="<?php echo e($currentApplicant->id); ?>">
                    </div>
                </div>
                <div class="col-md-6 col-xs-12">
                    <div class="form-group">
                        ...
                        <select class="select2 m-b-10 form-control select2-multiple " multiple="multiple"
                                data-placeholder="Pilih Karyawan" data-placeholder="Karyawan" name="employees[]">
            ...
            <div class="row">
                <div class="col-xs-6 col-md-4 ">
                    <div class="form-group">
                        ...
                        <input type="text" name="scheduleDate" id="scheduleDate" placeholder="Tanggal Jadwal" value="<?php echo e($scheduleDate); ?>" class="form-control">
                    </div>
                </div>
                ...
                <div class="col-xs-5 col-md-4">
                    <div class="form-group chooseCandidate bootstrap-timepicker timepicker">
                        ...
                        <input type="text" name="scheduleTime" id="scheduleTime" placeholder="Tanggal Waktu" class="form-control">
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xs-12 col-md-12 ">
                    <div class="form-group">
                        ...
                        <textarea type="text" name="comment" id="comment" placeholder="Komentar" class="form-control"></textarea>
                    </div>
                </div>
            </div>
        </div>
...
<?php /**PATH D:\kuliah\Belajar\web\laravel\SiRekrutV1\resources\views/admin/job-applications/interview-create.blade.php ENDPATH**/ ?>