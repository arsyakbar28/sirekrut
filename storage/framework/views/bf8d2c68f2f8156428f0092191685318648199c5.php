                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select name="company" class="form-control">
                                        ...
                                        <option <?php if($comp->id == $job->company_id): ?> selected <?php endif; ?>
                                            value="<?php echo e($comp->id); ?>"><?php echo e(ucwords($comp->company_name)); ?></option>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="job_description" name="job_description" rows="15"
                                        placeholder="Masukkan teks ..."><?php echo $job->job_description; ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="job_requirement" name="job_requirement" rows="15"
                                        placeholder="Masukkan teks ..."><?php echo $job->job_requirement; ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select name="location_id" id="location_id"
                                        ...
                                        <option <?php if($location->id == $job->location_id): ?> selected <?php endif; ?>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select name="category_id" id="category_id" class="form-control">
                                        ...
                                        <option <?php if($category->id == $job->category_id): ?> selected <?php endif; ?>
                                            value="<?php echo e($category->id); ?>"><?php echo e(ucfirst($category->name)); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select class="select2 m-b-10 select2-multiple" id="job_skills"
                                        ...
                                        data-placeholder="Tambah Keahlian" name="skill_id[]">
                                        <?php $__currentLoopData = $skills; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $skill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option <?php $__currentLoopData = $job->skills; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jskill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($skill->id == $jskill->skill_id): ?>
                                            selected
                                            <?php endif; ?>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            value="<?php echo e($skill->id); ?>"><?php echo e(ucwords($skill->name)); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="total_positions"
                                        id="total_positions" value="<?php echo e($job->total_positions); ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="date-start"
                                        value="<?php echo e($job->start_date->format('Y-m-d')); ?>" name="start_date">
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="date-end" name="end_date"
                                        value="<?php echo e($job->end_date->format('Y-m-d')); ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select name="status" id="status" class="form-control">
                                        <option <?php if($job->status == 'active'): ?> selected <?php endif; ?>
                                            value="active">Aktif</option>
                                        <option <?php if($job->status == 'inactive'): ?> selected <?php endif; ?>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="meta-title" class="form-control" name="meta_title" value="<?php echo e($job->meta_details['title']); ?>">
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea id="meta-description" class="form-control" name="meta_description" rows="3"><?php echo e($job->meta_details['description']); ?></textarea>
                                </div>
                            </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        <label class="">
                                            <div class="icheckbox_flat-green" aria-checked="false" aria-disabled="false"
                                                ...
                                                <input <?php if(in_array($question->id, $jobQuestion)): ?> checked <?php endif; ?>
                                                type="checkbox" value="<?php echo e($question->id); ?>" name="question[]" class="flat-red"
                                                style="position: absolute; opacity: 0;">
                                                <ins class="iCheck-helper"
                                                    style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;"></ins>
                                            </div>
                                            <?php echo e(ucfirst($question->question)); ?> <?php if($question->required ==
                                            'yes'): ?>(<?php echo app('translator')->get('app.required'); ?>)<?php endif; ?>
                                        </label>
                                    </div>
                            ...
                            <div class="col-md-12">
                                <div id="columns">
                                    ...
                                    <div class="form-group form-group-inline">
                                        <?php $__currentLoopData = $job->required_columns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <label class="mr-4">
                                            <div class="icheckbox_flat-green" aria-checked="false" aria-disabled="false"
                                                style="position: relative;">
                                                <input <?php if($value): ?> checked <?php endif; ?> type="checkbox" value="<?php echo e($key); ?>"
                                                    name="<?php echo e($key); ?>" class="flat-red"
                                                    style="position: absolute; opacity: 0;">
                                                <ins class="iCheck-helper"
                                                    style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;"></ins>
                                            </div>
                            ...
                            <div class="col-md-12">
                                <div id="columns">
                                    ...
                                    <div class="form-group form-group-inline">
                                        <?php $__currentLoopData = $job->section_visibility; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <label class="mr-4">
                                            <div class="icheckbox_flat-green" aria-checked="false" aria-disabled="false"
                                                style="position: relative;">
                                                <input <?php if($value == 'yes'): ?> checked <?php endif; ?> type="checkbox" value="yes"
                                                    name="<?php echo e($key); ?>" class="flat-red"
                                                    style="position: absolute; opacity: 0;">
                                                <ins class="iCheck-helper"
                                                    style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;"></ins>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\kuliah\Belajar\web\laravel\SiRekrutV1\resources\views/admin/jobs/edit.blade.php ENDPATH**/ ?>