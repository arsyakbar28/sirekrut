    ...
    <div class="row">
        <div class="col-md-12 mb-2">
                ...
                <a href="<?php echo e(route('admin.interview-schedule.table-view')); ?>"
                   class="btn btn-sm btn-primary">Tampilan Tabel <i class="fa fa-table"></i></a>
                <?php endif; // Entrust::can ?>
                <?php if (\Entrust::can('add_schedule')) : ?>
                <a href="#" data-toggle="modal" onclick="createSchedule()"
                   class="btn btn-sm btn-success waves-effect waves-light">
                    <i class="ti-plus"></i> Tambah Jadwal Interview
                </a>
                <?php endif; // Entrust::can ?>
        </div>
    </div>
            ...
            <div class="card">
                <div class="card-header d-flex p-0 ui-sortable-handle">
                    <h3 class="card-title p-3">
                        <i class="fa fa-file"></i> Jadwal Interview
                    </h3>
                </div><!-- /.card-header -->
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\kuliah\Belajar\web\laravel\SiRekrutV1\resources\views/admin/interview-schedule/index.blade.php ENDPATH**/ ?>